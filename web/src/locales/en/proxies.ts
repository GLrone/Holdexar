...
const proxies: Partial<Record<MessageKey, string>> = {
  ...
  /* Production runs (real crawl job ledger: facts only, no health verdicts) */
  'proxies.section.jobs': 'Production runs',
  'proxies.jobs.desc':
    'One row per real crawl run; this section records facts only, never a health verdict.',
  'proxies.jobs.total': '{n} total',
  'proxies.jobs.refresh': 'Refresh',
  'proxies.jobs.loadFailed': 'Could not load production run records',
  'proxies.jobs.empty': 'No production runs yet — one will appear after a crawl',
  'proxies.jobs.extra': 'Also: {interrupted} interrupted · {running} running',
  'proxies.jobs.stat.runs': 'Runs',
  'proxies.jobs.stat.success': 'Succeeded',
  ...
  'proxies.jobs.col.success': 'OK',
  'proxies.jobs.col.failed': 'Failed',
  'proxies.jobs.col.duration': 'Duration',
  'proxies.jobs.col.node': 'Node',
  'proxies.jobs.col.exitIp': 'Exit IP',
  'proxies.jobs.status.running': 'Running',
  'proxies.jobs.status.success': 'Succeeded',
  'proxies.jobs.status.partial': 'Partial',
  'proxies.jobs.status.failed': 'Failed',
  'proxies.jobs.status.interrupted': 'Interrupted',
  'proxies.jobs.detail.title': 'Run #{id}',
  'proxies.jobs.detail.basic': 'This run',
  'proxies.jobs.detail.node': 'Node used',
  'proxies.jobs.detail.nodeUnknown': 'Not recorded (controller read failed, or not started yet)',
  'proxies.jobs.detail.startedAt': 'Started',
  'proxies.jobs.detail.finishedAt': 'Finished',
  'proxies.jobs.detail.duration': 'Duration',
  'proxies.jobs.detail.proxyUrl': 'Pool entry',
  'proxies.jobs.detail.poolSha': 'Pool SHA',
  'proxies.jobs.detail.poolNodes': 'Pool nodes',
  'proxies.jobs.detail.poolExitIps': 'Pool exit IPs',
  'proxies.jobs.detail.subscriptions': 'Source subscriptions',
  'proxies.jobs.detail.snapshots': 'Snapshots',
  'proxies.jobs.detail.errors': 'Error kinds',
  'proxies.jobs.detail.errorsNone': 'No error kinds recorded for this run',
  'proxies.jobs.detail.summaryMissing':
    'No error summary for this row (interrupted or an earlier run)',
  'proxies.jobs.detail.truncated': 'Detail truncated',
  'proxies.jobs.detail.interrupted':
    'This run did not finish (process interrupted or stopped by hand)',
  /* Error kinds (must mirror the backend jobruns.ERROR_KINDS list) */
  'proxies.jobs.err.timeout': 'Timeout',
  'proxies.jobs.err.connect': 'Connect failed',
  'proxies.jobs.err.reset': 'Connection reset',
  'proxies.jobs.err.proxy_error': 'Proxy error',
  'proxies.jobs.err.rate_limit': 'Rate limited (429)',
  'proxies.jobs.err.http_4xx': 'HTTP 4xx',
  'proxies.jobs.err.http_5xx': 'HTTP 5xx',
  'proxies.jobs.err.tls': 'TLS error',
  'proxies.jobs.err.dns': 'DNS failure',
  'proxies.jobs.err.ledger': 'Batch retries exhausted',
  'proxies.jobs.err.internal': 'Internal error',
  'proxies.jobs.err.other': 'Other',
